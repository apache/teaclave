...
impl Storable<Email> for SubscriptionInfo {
...
impl SubscriptionInfo {
    ...
    pub fn subscribe(&mut self, wallet: &WalletID) {
        self.wallets.insert(wallet.clone());
    }

    pub fn unsubscribe(&mut self, wallet: &WalletID) {
        self.wallets.remove(wallet);
    }

    pub fn is_subscribed(&self, wallet: &WalletID) -> bool {
